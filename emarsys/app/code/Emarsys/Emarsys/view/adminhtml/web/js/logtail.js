...
return; }
        ...
        var syncProcess = "Sync process completed!";
        var testConnectionProcess = "Test Connection completed!";
        var defaultConfiguration = "Default configuration completed!";
        var response = 0;

        if (t.indexOf(syncProcess) > 0 || t.indexOf(testConnectionProcess) > 0 || t.indexOf(defaultConfiguration) > 0) {
            document.getElementById('sync-process-img').style.display = 'none';
