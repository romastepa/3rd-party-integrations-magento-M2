...
return G.apply(d, b.getElementsByClassName(f)), d
                ...
                if (c.qsa && !A[a + " "] && (!q || !q.test(a))) {
                    if (1 !== w) {
s = b, r = a; } else if ("object" !== b.nodeName.toLowerCase()) {
...
V.set(a[c], "globalEval", !b || V.get(b[c], "globalEval"))
    ...
    {
        for (var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], n = 0, o = a.length; o > n; n++)if (f = a[n], f || 0 === f)if ("object" === r.type(f)) {
r.merge(m, f.nodeType ? [f] : f); } else if (na.test(f)) {
...
m.push(b.createTextNode(f)); }
        l.textContent = "", n = 0;
        while (f = m[n++])if (d && r.inArray(f, d) > -1) {
e && e.push(f); } else if (j = r.contains(f.ownerDocument, f), g = la(l.appendChild(f), "script"), j && ma(g), c) {
            k = 0;
            while (f = g[k++]) {
